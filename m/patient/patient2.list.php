...
// 定义当前页需要用到的调用参数:
$link_param = explode(" ", "page material_date sort order key begin_time end_time time_type show come kefu_23_name kefu_4_name doctor_name xiaofei disease part_id from depart names date list_huifang media");
...
// 定义单元格格式:
$list_heads = array(
	"编号" => array("align"=>"center", "sort"=>"id", "order"=>"asc"),
	...
	"分组" => array("align"=>"center", "sort"=>"qq", "order"=>"asc"),
	...
	"到院时间" => array("width"=>"70", "align"=>"center", "sort"=>"material_date", "order"=>"desc"),
	...
	"预约类别" => array("align"=>"center", "sort"=>"leibie", "order"=>"asc"),
