...
<!--    <form action="ajax_update.php" onClick="ajax_submit(this); return false;">
      ...
      <button id="click" style="border:0; background:#FFF; color:#F00;"><?php echo '(添加)'; ?></button><div id="t"></div>
...
document.getElementById("click").onclick=function(){
    ...
    <!--<form action="ajax_update.php" onSubmit="ajax_submit(this); return false;">
      ...
      <button id="click2" style="border:0; background:#FFF; color:#F00;"><?php echo '(添加)'; ?></button><div id="t1"></div>
<script type="text/javascript">
