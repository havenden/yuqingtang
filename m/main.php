...
//网络部 
   ...
   $sy_daoyuan_order = $db->query("select count(*) as count,author from $table where status = 1 and order_date>=$lastmonth_tb and order_date<$month_tb and part_id!=4 group by author order by count desc limit 0,10");
   $sy_yuyue_order = $db->query("select count(*) as count,author from $table where status != 3 and addtime>=$lastmonth_tb and addtime<$month_tb and part_id!=4 group by author order by count desc limit 0,10");
...
<?php if ($username == "admin" || $debug_mode || in_array($uinfo["part_id"], array(1,9)) || ($uinfo["part_admin"] && in_array(3,$manage_parts)) ) { ?>
<?php
$table = "patient_".$user_hospital_id;
$tel_1 = $db->query("select count(*) as count from $table where part_id=3 and addtime>=$today_tb and addtime<$today_te", 1, "count");
$tel_2 = $db->query("select count(*) as count from $table where part_id=3 and addtime>=$yesterday_tb and addtime<$today_tb", 1, "count");
$tel_3 = $db->query("select count(*) as count from $table where part_id=3 and addtime>=$month_tb and addtime<$month_te", 1, "count");

$tel_4 = $db->query("select count(*) as count from $table where part_id=3 and status=1 and order_date>=$today_tb and order_date<$today_te", 1, "count");
$tel_5 = $db->query("select count(*) as count from $table where part_id=3 and status=1 and order_date>=$yesterday_tb and order_date<$today_tb", 1, "count");
$tel_6 = $db->query("select count(*) as count from $table where part_id=3 and status=1 and order_date>=$month_tb and order_date<$month_te", 1, "count");

$tel_7 = $db->query("select count(*) as count from $table where part_id=3 and order_date>=$today_tb and order_date<$today_te", 1, "count");
$tel_8 = $db->query("select count(*) as count from $table where part_id=3 and order_date>=$yesterday_tb and order_date<$today_tb", 1, "count");
$tel_9 = $db->query("select count(*) as count from $table where part_id=3 and order_date>=$month_tb and order_date<$month_te", 1, "count");

// 同比
$tel_tb1 = $db->query("select count(*) as count from $table where part_id=3 and addtime>=$tb_tb and addtime<$tb_te", 1, "count");
$tel_tb2 = $db->query("select count(*) as count from $table where part_id=3 and order_date>=$tb_tb and order_date<$tb_te", 1, "count");
$tel_tb3 = $db->query("select count(*) as count from $table where part_id=3 and order_date>=$tb_tb and order_date<$tb_te and status=1", 1, "count");

?>
<div style="float:left; width:300px; padding-left:10px;">
<table width="300" class="edit" style="margin-top:10px;">
	<tr>
		<td colspan="2" class="head">电话部</td>
	</tr>
	<tr>
		<td class="left" style="width:20%">今日：</td>
		<td class="right">
			约:<a href="/m/patient/patient.php?show=today&time_type=addtime&part_id=3">&nbsp;<b><?php echo $tel_1; ?></b>&nbsp;</a>
			预计:<a href="/m/patient/patient.php?show=today&part_id=3">&nbsp;<b><?php echo $tel_7; ?></b>&nbsp;</a>
	...
	<tr>
		<td class="left">昨日：</td>
		<td class="right">
			约:<a href="/m/patient/patient.php?show=yesterday&time_type=addtime&part_id=3">&nbsp;<b><?php echo $tel_2; ?></b>&nbsp;</a>
			预计:<a href="/m/patient/patient.php?show=yesterday&part_id=3">&nbsp;<b><?php echo $tel_8; ?></b>&nbsp;</a>
			到:<a href="/m/patient/patient.php?show=yesterday&part_id=3&come=1">&nbsp;<b><?php echo $tel_5; ?></b>&nbsp;</a>
		</td>
	</tr>
	<tr>
		<td class="left">本月：</td>
		<td class="right">
			约:<a href="/m/patient/patient.php?show=thismonth&time_type=addtime&part_id=3">&nbsp;<b><?php echo $tel_3; ?></b>&nbsp;</a>
			预计:<a href="/m/patient/patient.php?show=thismonth&part_id=3">&nbsp;<b><?php echo $tel_9; ?></b>&nbsp;</a>
			到:<a href="/m/patient/patient.php?show=thismonth&part_id=3&come=1">&nbsp;<b><?php echo $tel_6; ?></b>&nbsp;</a>
		</td>
	</tr>
	<tr>
		<td class="left" style="color:silver">同比：</td>
...
<?php if ($username == "admin" || $debug_mode || in_array($uinfo["part_id"], array(1,9)) || ($uinfo["part_admin"] && in_array(26,$manage_parts)) ) { ?>
<?php
$table = "patient_".$user_hospital_id;
$tel_1 = $db->query("select count(*) as count from $table where part_id=26 and addtime>=$today_tb and addtime<$today_te", 1, "count");
$tel_2 = $db->query("select count(*) as count from $table where part_id=26 and addtime>=$yesterday_tb and addtime<$today_tb", 1, "count");
$tel_3 = $db->query("select count(*) as count from $table where part_id=26 and addtime>=$month_tb and addtime<$month_te", 1, "count");

$tel_4 = $db->query("select count(*) as count from $table where part_id=26 and status=1 and order_date>=$today_tb and order_date<$today_te", 1, "count");
$tel_5 = $db->query("select count(*) as count from $table where part_id=26 and status=1 and order_date>=$yesterday_tb and order_date<$today_tb", 1, "count");
$tel_6 = $db->query("select count(*) as count from $table where part_id=26 and status=1 and order_date>=$month_tb and order_date<$month_te", 1, "count");

$tel_7 = $db->query("select count(*) as count from $table where part_id=26 and order_date>=$today_tb and order_date<$today_te", 1, "count");
$tel_8 = $db->query("select count(*) as count from $table where part_id=26 and order_date>=$yesterday_tb and order_date<$today_tb", 1, "count");
$tel_9 = $db->query("select count(*) as count from $table where part_id=26 and order_date>=$month_tb and order_date<$month_te", 1, "count");

// 同比
$tel_tb1 = $db->query("select count(*) as count from $table where part_id=26 and addtime>=$tb_tb and addtime<$tb_te", 1, "count");
$tel_tb2 = $db->query("select count(*) as count from $table where part_id=26 and order_date>=$tb_tb and order_date<$tb_te", 1, "count");
$tel_tb3 = $db->query("select count(*) as count from $table where part_id=26 and order_date>=$tb_tb and order_date<$tb_te and status=1", 1, "count");

?>
<div style="float:left; width:300px; padding-left:10px;">
<table width="300" class="edit" style="margin-top:10px;">
	<tr>
		<td colspan="2" class="head">市场部</td>
	</tr>
	<tr>
		<td class="left" style="width:20%">今日：</td>
		<td class="right">
			约:<a href="/m/patient/patient.php?show=today&time_type=addtime&part_id=26">&nbsp;<b><?php echo $tel_1; ?></b>&nbsp;</a>
			预计:<a href="/m/patient/patient.php?show=today&part_id=26">&nbsp;<b><?php echo $tel_7; ?></b>&nbsp;</a>
			到:<a href="/m/patient/patient.php?show=today&part_id=26&come=1">&nbsp;<b><?php echo $tel_4; ?></b>&nbsp;</a>
		</td>
	</tr>
	<tr>
		<td class="left">昨日：</td>
		<td class="right">
			约:<a href="/m/patient/patient.php?show=yesterday&time_type=addtime&part_id=26">&nbsp;<b><?php echo $tel_2; ?></b>&nbsp;</a>
			预计:<a href="/m/patient/patient.php?show=yesterday&part_id=26">&nbsp;<b><?php echo $tel_8; ?></b>&nbsp;</a>
			到:<a href="/m/patient/patient.php?show=yesterday&part_id=26&come=1">&nbsp;<b><?php echo $tel_5; ?></b>&nbsp;</a>
		</td>
	</tr>
	<tr>
		<td class="left">本月：</td>
		<td class="right">
			约:<a href="/m/patient/patient.php?show=thismonth&time_type=addtime&part_id=26">&nbsp;<b><?php echo $tel_3; ?></b>&nbsp;</a>
			预计:<a href="/m/patient/patient.php?show=thismonth&part_id=26">&nbsp;<b><?php echo $tel_9; ?></b>&nbsp;</a>
			到:<a href="/m/patient/patient.php?show=thismonth&part_id=26&come=1">&nbsp;<b><?php echo $tel_6; ?></b>&nbsp;</a>
		</td>
	</tr>
	<tr>
		<td class="left" style="color:silver">同比：</td>
...
<table width="300" class="edit" style="margin-top:10px;">
	...
	<tr>
		...
		<td class="right">
			...
			到:<a href="/m/patient/patient.php?show=today&part_id=11&come=1">&nbsp;<b><?php echo $tel_4; ?></b>&nbsp;</a>
		</td>
	</tr>
	<tr>
		<td class="left">昨日：</td>
...
<?php if ($username == "admin" || in_array($uinfo["part_id"], array(1,9)) || ($uinfo["part_admin"] && in_array(27,$manage_parts)) ) { ?>
<?php
$table = "patient_".$user_hospital_id;
$tel_1 = $db->query("select count(*) as count from $table where part_id=27 and addtime>=$today_tb and addtime<$today_te", 1, "count");
$tel_2 = $db->query("select count(*) as count from $table where part_id=27 and addtime>=$yesterday_tb and addtime<$today_tb", 1, "count");
$tel_3 = $db->query("select count(*) as count from $table where part_id=27 and addtime>=$month_tb and addtime<$month_te", 1, "count");
$tel_31 = $db->query("select count(*) as count from $table where part_id=27 and addtime>=$lastmonth_tb and addtime<$month_tb", 1, "count");

$tel_4 = $db->query("select count(*) as count from $table where part_id=27 and status=1 and order_date>=$today_tb and order_date<$today_te", 1, "count");
$tel_5 = $db->query("select count(*) as count from $table where part_id=27 and status=1 and order_date>=$yesterday_tb and order_date<$today_tb", 1, "count");
$tel_6 = $db->query("select count(*) as count from $table where part_id=27 and status=1 and order_date>=$month_tb and order_date<$month_te", 1, "count");
$tel_61 = $db->query("select count(*) as count from $table where part_id=27 and status=1 and order_date>=$lastmonth_tb and order_date<$month_tb", 1, "count");

$tel_7 = $db->query("select count(*) as count from $table where part_id=27 and order_date>=$today_tb and order_date<$today_te", 1, "count");
$tel_8 = $db->query("select count(*) as count from $table where part_id=27 and order_date>=$yesterday_tb and order_date<$today_tb", 1, "count");
$tel_9 = $db->query("select count(*) as count from $table where part_id=27 and order_date>=$month_tb and order_date<$month_te", 1, "count");
$tel_91 = $db->query("select count(*) as count from $table where part_id=27 and order_date>=$lastmonth_tb and order_date<$month_tb", 1, "count");
// 同比
$tel_tb1 = $db->query("select count(*) as count from $table where part_id=27 and addtime>=$tb_tb and addtime<$tb_te", 1, "count");
$tel_tb2 = $db->query("select count(*) as count from $table where part_id=27 and order_date>=$tb_tb and order_date<$tb_te", 1, "count");
$tel_tb3 = $db->query("select count(*) as count from $table where part_id=27 and addtime>=$tb_tb and addtime<$tb_te and status=1", 1, "count");

?>
<div style="float:left; width:300px; padding-left:10px;">
<table width="300" class="edit" style="margin-top:10px;">
	<tr>
		<td colspan="2" class="head">外包新媒体3</td>
	</tr>
	<tr>
		<td class="left" style="width:20%">今日：</td>
		<td class="right">
			约:<a href="/m/patient/patient.php?show=today&time_type=addtime&part_id=27">&nbsp;<b><?php echo $tel_1; ?></b>&nbsp;</a>
			预计:<a href="/m/patient/patient.php?show=today&part_id=27">&nbsp;<b><?php echo $tel_7; ?></b>&nbsp;</a>
			到:<a href="/m/patient/patient.php?show=today&part_id=27&come=1">&nbsp;<b><?php echo $tel_4; ?></b>&nbsp;</a>
		</td>
	</tr>
	<tr>
		<td class="left">昨日：</td>
		<td class="right">
			约:<a href="/m/patient/patient.php?show=yesterday&time_type=addtime&part_id=27">&nbsp;<b><?php echo $tel_2; ?></b>&nbsp;</a>
			预计:<a href="/m/patient/patient.php?show=yesterday&part_id=27">&nbsp;<b><?php echo $tel_8; ?></b>&nbsp;</a>
			到:<a href="/m/patient/patient.php?show=yesterday&part_id=27&come=1">&nbsp;<b><?php echo $tel_5; ?></b>&nbsp;</a>
		</td>
	</tr>
	<tr>
		<td class="left">本月：</td>
		<td class="right">
			约:<a href="/m/patient/patient.php?show=thismonth&time_type=addtime&part_id=27">&nbsp;<b><?php echo $tel_3; ?></b>&nbsp;</a>
			预计:<a href="/m/patient/patient.php?show=thismonth&part_id=27">&nbsp;<b><?php echo $tel_9; ?></b>&nbsp;</a>
			到:<a href="/m/patient/patient.php?show=thismonth&part_id=27&come=1">&nbsp;<b><?php echo $tel_6; ?></b>&nbsp;</a>
		</td>
	</tr>
	<tr>
		<td class="left" style="color:silver">同比：</td>
